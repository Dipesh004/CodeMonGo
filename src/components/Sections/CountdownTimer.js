...
export const FlipDate = ({ value }) => {
  ...
  useEffect(() => {
    ...
    const timeDuration = Tick.helper.duration(1,"months");
...
//     const offset = new Date();
//     const timeDuration = Tick.helper.duration(days,hours,minutes,seconds);
...
//     const counter = Tick.count.down(deadline, {
//       format: ["d", "h", "m", "s"] // Update format to include days
//     });
