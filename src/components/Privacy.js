    ...
    <>
      ...
      >
        ...
        <p style={{ width: "80%", margin: "auto", marginBottom: "2rem" }}>
          At Ocpl Tech, accessible from https://ocpl.tech, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Ocpl Tech and how we use it. I you have additional questions or
          ...
          information that they shared and/or collect in Ocpl Tech. This policy
        ...
        <h4 style={{ marginBottom: "1rem" }}>Consent</h4>
        <p style={{ width: "80%", margin: "auto", marginBottom: "2rem" }}>
          By using our website, you hereby consent to our Privacy Policy and
          agree to its terms.
        </p>
        <h4 style={{ marginBottom: "1rem" }}>Information we collect</h4>
        <p style={{ width: "80%", margin: "auto", marginBottom: "2rem" }}>
        ...
        <h4 style={{ marginBottom: "1rem" }}>How we use your information</h4>
        <p style={{ width: "80%", margin: "auto", marginBottom: "2rem" }}>
        ...
        <h4 style={{ marginBottom: "1rem" }}>Log Files</h4>
        <p style={{ width: "80%", margin: "auto", marginBottom: "2rem" }}>
          Ocpl Tech follows a standard procedure of using log files. These files
        ...
        <p style={{ width: "80%", margin: "auto", marginBottom: "2rem" }}>
          ...
          advertising partners of Ocpl Tech. Third-party ad servers or ad
          ...
          on Ocpl Tech, which are sent directly to users' browser. They
          automatically receive your IP address when this occurs. These
          technologies are used to measure the effectiveness of their
          advertising campaigns and/or to personalize the advertising content
          that you see on websites that you visit. Note that Ocpl Tech has no
          access to or control over these cookies that are used by third-party
          advertisers.
        </p>
        <h4 style={{ marginBottom: "1rem" }}>Third Party Privacy Policies</h4>
        <p style={{ width: "80%", margin: "auto", marginBottom: "2rem" }}>
          Ocpl Tech's Privacy Policy does not apply to other advertisers or
        ...
        <h4 style={{ marginBottom: "1rem" }}>GDPR Data Protection Rights</h4>
        <p style={{ width: "80%", margin: "auto", marginBottom: "2rem" }}>
        ...
        <h4 style={{ marginBottom: "1rem" }}>Children's Information</h4>
        <p style={{ width: "80%", margin: "auto", marginBottom: "2rem" }}>
          Another part of our priority is adding protection for children while
          using the internet. We encourage parents and guardians to observe,
          participate in, and/or monitor and guide their online activity. Ocpl
          Tech does not knowingly collect any Personal Identifiable Information
